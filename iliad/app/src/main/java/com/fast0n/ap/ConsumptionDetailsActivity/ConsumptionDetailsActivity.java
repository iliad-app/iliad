...
public class ConsumptionDetailsActivity extends AppCompatActivity {
    ...
    private final ArrayList<ModelChildren> title = new ArrayList<>();
    private final ArrayList<ModelChildren> desc = new ArrayList<>();
    private final ArrayList<ModelChildren> info = new ArrayList<>();
        ...
        JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    ...
                    try {
                        ...
                        ArrayList[] ConsumptionDetails = new ArrayList[]{title, desc, info};
