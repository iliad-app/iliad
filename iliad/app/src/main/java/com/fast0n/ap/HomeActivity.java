...
public class HomeActivity extends AppCompatActivity {
    ...
    String account, toggleState, userid, password, theme, alert;
    private int pos = 0;
        ...
        JsonObjectRequest getRequest1 = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        ...
                        Log.e(getString(R.string.app_name), String.valueOf(error));
                    }

                },
                error -> Log.e(getString(R.string.app_name), String.valueOf(error)));
        // add it to the RequestQueue3
