                ...
                response -> {
                    try {
                        ...
                        if (BuildConfig.VERSION_CODE < Integer.parseInt(stringVersion)) {
                            ...
                            AlertDialog dialog = new AlertDialog.Builder(this)
                                    .setTitle(R.string.dlgTitleUpdate)
                                    .setMessage(String.format(getString(R.string.dlgMsgUpdate), getString(R.string.app_name), stringVersion))
                                    .setCancelable(false)
                                    .setPositiveButton(R.string.dlgBtnUpdate, null)
                                    .show();

                            Button btnUpdate = dialog.getButton(AlertDialog.BUTTON_POSITIVE);
                            btnUpdate.setOnClickListener(v -> startActivity(new Intent(Intent.ACTION_VIEW).setData(Uri.parse("http://github.com/fast0n/iliad/releases/latest"))));
                            ...
                            result = new DrawerBuilder()
                                    ...
                                    .withOnDrawerItemClickListener((view, position, drawerItem) -> {
                                        ...
                                        if (drawerItem != null  && isOnline()) {
                                            ...
                                            AlertDialog dialog = new AlertDialog.Builder(this)
                                                    .setTitle(R.string.errorconnection)
                                                    .setMessage(R.string.errorconnection_one)
                                                    .setCancelable(false)
                                            ...
                                            btnUpdate.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    if (isOnline())
                                                        ...
                                                        Toasty.info(HomeActivity.this, getString(R.string.errorconnection_one), Toast.LENGTH_SHORT, true)
                                                                .show();
